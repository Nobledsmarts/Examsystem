...
export default {
    ...
    computed : {
        getMarks () {
            return this.$store.state.db.subjects[this.getSubjectId(this.currentExam.subject.toLowerCase())]['term'][this.term].marks;
        },
        getSubjectId(){
            return (subject) => {
              return this.$store.getters.subjectId(subject);
            }
        },
        examEnd(){
    ...
    created(){
        ...
        if(query.subject){
            ...
            this.questions = this.$store.state.db.subjects[this.getSubjectId(this.currentExam.subject)]['term'][this.term]['questions'];
        }
        ...
        <div class="container-fluid" align="center">
            ...
            <div class="row">
                ...
                <div class="col-md-8 exam-main-content shadow bg-light" style="border:1px solid #fff">
                    ...
                    <div v-if="isPreview" class="clearfix">
                        <div class="float-right text-light p-1 bg-info">
                            viewing Preview
                        </div>
                        </div>
               ...
               <div class="col-md-2">
                    <button :disabled="isPreview" @click="submitExam" class="btn btn-danger btn-block btn-md"> 
                        submit
                    </button>
                </div>
           </div>
